...
Builds :class:`~diffav.core.geometry.RoadEdges` from the roadgraph
...
from diffav.core.geometry import RoadEdges, stack_polylines_fixed
...
def fixed_shape_road_edges_from_wod_dict(
    ...
    *,
    ...
    :func:`~diffav.core.geometry.signed_distance_to_polylines`, not by these
