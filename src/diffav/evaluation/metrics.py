...
from diffav.core.constants import WOSAC_2025_KINEMATIC_ENVELOPE
from diffav.core.geometry import RoadEdges, signed_distances_to_road_edges
from diffav.physics.kinematics import compute_kinematic_features
    ...
    *,
    ...
    Args:
        ...
        chunk_size: Optional polyline-chunk size bounding the closest-segment
            search memory (see
            :func:`~diffav.core.geometry.signed_distances_to_road_edges`).
