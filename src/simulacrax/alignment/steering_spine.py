...
from simulacrax.alignment.rewards import SafetyReward
...
def sample_and_score(
    ...
    *,
    ...
    from simulacrax.alignment.scenario_steering import compute_scenario_reward  # noqa: PLC0415
...
def make_adversarial_guidance(
    *,
    ...
    :meth:`~simulacrax.api.map_conditioned.MapConditionedTrajectoryModel.sample`
