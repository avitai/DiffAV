...
from simulacrax.core.constants import WOD_STEP_DURATION_SECONDS
from simulacrax.core.geometry import mean_offroad_penalty
...
class BoundaryReward:
    ...
    holding a :class:`~simulacrax.core.geometry.RoadEdges`; returns zero
