...
Composes opifex's :class:`OrbaxCheckpointStore` with simulacrax-specific
...
class SimulacraxCheckpointManager:
    """Checkpoint manager for simulacrax trajectory model training.
