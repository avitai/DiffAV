...
from simulacrax.evaluation.metrics import ade as _ade, fde as _fde
...
def _classify_failure_mode(loss_components: dict[str, jax.Array]) -> str:
    ...
    Args:
        loss_components: Dict from ``SimulacraxPhysicsLoss.compute_loss``.
...
class ScenarioMiner:
        ...
        *,
        ...
        Args:
            scenario_type: Scene template — one of
                :class:`~simulacrax.core.types.ScenarioType` (``"forward"``,
                ``"lane_change"``, ``"unprotected_left_turn"``,
                ``"adversarial"``).
            density: Agent density — one of
                :class:`~simulacrax.core.types.Density`: ``"low"`` (2),
                ...
                scenarios.append(
                    Scenario(
                        ...
                        metadata=ScenarioMetadata(
                            ...
                            source_dataset="simulacrax_synthetic",
    ...
    def evaluate_planner(
        ...
        Uses standalone :func:`~simulacrax.evaluation.metrics.ade` and
        :func:`~simulacrax.evaluation.metrics.fde` from
        ``simulacrax.evaluation.metrics``, vmapped over agents.
        ...
        return [
            replace(
                ...
                metadata=ScenarioMetadata(
                    ...
                    source_dataset="simulacrax_steered",
    ...
    def _train_steering_expert(
        ...
        """
        from simulacrax.alignment.dpo_trainer import (  # noqa: PLC0415
            DPOAlignmentConfig,
            DPOAlignmentTrainer,
        )
    ...
    def adversarial_search(
        ...
        *,
        ...
        ``planner_fn`` and its output scored by ``SimulacraxPhysicsLoss``. A
        ...
        ``simulacrax.core.training_utils.nan_safe_gradients``.
        ...
        for index, candidate in enumerate(candidates):
            ...
            adv_scenario = Scenario(
                ...
                metadata=ScenarioMetadata(
                    ...
                    source_dataset="simulacrax_adversarial",
                    tags=("adversarial",),
                ),
            )
...
def _load_checkpoint_into_model(model: TrajectoryDiffusionModel, checkpoint_path: str) -> None:
    """Restore model parameters from a SimulacraxCheckpointManager checkpoint.
    ...
    """
    from simulacrax.models.checkpointing import (  # noqa: PLC0415
        CheckpointConfig,
    ...
    with SimulacraxCheckpointManager(CheckpointConfig(checkpoint_dir=checkpoint_path)) as manager:
