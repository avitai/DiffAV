...
:func:`~simulacrax.alignment.dpo_trainer.dpo_loss_from_log_probs`; only the
...
from simulacrax.alignment.dpo_trainer import dpo_loss_from_log_probs, DPOAlignmentConfig
