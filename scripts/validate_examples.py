...
Usage:
    ...
    python scripts/validate_examples.py --path examples/core/
...
Validation checks:
    1. Core structure presence (overview + markdown/code cell organization)
...
LEARNING_GOALS_PATTERN = re.compile(
    r"(?:Learning Goals|Learning Objectives|What You'll Learn)",
    re.IGNORECASE,
)
